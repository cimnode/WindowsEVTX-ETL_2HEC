...
for( $i = 0; $i -lt $JobQuantity; $i++)
{
	...
	start-threadjob -ScriptBlock {.\WinETL-EVTX2HEC.ps1 -EventFilePath "$using:EventFilePath" -SecondsMinusEarliest $using:job_start_seconds -SecondsMinusLatest $using:job_end_seconds} 
